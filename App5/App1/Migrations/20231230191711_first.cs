    ...
    public partial class first : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "New York", "USA", "TechCorp Solutions", 10001 },
                    { 2, "Beverly Hills", "USA", "GlobalWidgets Inc", 90210 },
                    { 3, "London", "UK", "InnovateSoft Ltd", 58643 },
                    { 4, "Paris", "France", "NexGen Innovations", 75001 },
                    { 5, "Berlin", "Germany", "BrightFutures Corp", 10178 }
                });
